        ...
        <div class="d-flex">
            ...
            <!-- <div class="navbar-brand-box">
                <a href="index.php" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="assets/images/logo.png" alt="logo-dark" height="22">
                    </span>
                </a>
                ...
                <a href="index.php" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="assets/images/logo.png" alt="logo-light" height="22">
                    </span>
                </a>
            </div> -->
            ...
            <div class="d-flex align-items-center" style="height: 70px">
                <a href="index.php"><img src="assets/images/logo.png" alt="logo-light" height="22"></a>
            </div>
                ...
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    if (empty($delivery_photo)) {
                        ...
                        <img class="rounded-circle header-profile-user"
                            src="../admin/<?php echo htmlspecialchars($delivery_photo); ?>" alt="">
                        <?php
                    }
                    ?>


                    <span class="d-none d-xl-inline-block ms-1"><?php echo "$delivery_name" ?></span>
                    <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="profile.php"><i class="ri-user-line align-middle me-1"></i>
                        Profile</a>
