...
<head>
    ...
    <title>Today Orders | Admin | Usemee</title>
</head>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Today Order</h4>
                    ...
                    $query = "SELECT * FROM `orders` WHERE `zone`= '$admin_zone' AND DATE(`order_date`) = CURDATE() $status_filter ORDER BY `id` DESC";
            ...
            Swal.fire({
                ...
                window.location.href = 'today_order.php?status=Pending'; 
            });
        </script>";
                                        } else {
                                            // Error alert
            ...
            Swal.fire({
                ...
                window.location.href = 'today_order.php?status=Confirmed'; 
            });
        </script>";
                                    } else {
                                        // Error alert
